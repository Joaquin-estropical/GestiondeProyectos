...
-- Crea todas las tablas del módulo Planillas + seed inicial
-- ================================================================

-- Tabla: plantillas de planillas
...
-- Tabla: planillas activas (por proyecto o área)
...
-- Tabla: ítems de planilla activa
...
-- RLS (igual que el resto de la app — permisivo)
